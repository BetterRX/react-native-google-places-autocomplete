...
const FloatingTextInput = require('react-native-floating-label-text-input');
      ...
      >
        ...
        >
          <FloatingTextInput
            ...
            onChangeTextValue={onChangeText ? text => {this._onChangeText(text); onChangeText(text)} : this._onChangeText}
